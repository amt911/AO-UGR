...
En cuanto a la animación, la he realizado con tres \textit{keyframes}: uno para la posición más a la izquierda, otro para la posición más a la derecha y de nuevo a la izquierda. Además, he tenido en cuenta que al ser cíclico, los \textit{keyframes} deben estar al principio, en el medio y al final, para que la animación se pueda \textit{loopear}. Estos son:
