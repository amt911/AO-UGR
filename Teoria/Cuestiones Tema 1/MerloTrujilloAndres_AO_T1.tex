...
\begin{itemize}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[width=0.6\textwidth]{imagenes/taumatropo2.jpg}
        \caption{Ilustración de un taumátropo. Obtenido de: \url{https://proyectoidis.org/taumatropo/}}
	\end{figure}
	...
	\begin{figure}[H]
	    \centering
	    \includegraphics[width=0.4\textwidth]{imagenes/Kinetoscope.jpg}
        \caption{Mecanismo de un kinetoscopio. Obtenido de: \url{https://es.wikipedia.org/wiki/Quinetoscopio}}
	\end{figure}
