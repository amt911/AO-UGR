...
% Una característica que separa este algoritmo de los demás, es la capacidad de poder ``teñir'' los objetos del color de otros a su alrededor e incluso la luz.

%ejemplos de rt
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/minecraft1.png}
